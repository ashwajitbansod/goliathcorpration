   ...
   document.getElementsByTagName("BODY")[0].className += " safari";
			...
			?>
				...
				<div class="col-sm-4 <?php if ($fehler["name"] != "") { echo 'error'; } ?>">
					...
					<input <?php if($cfg['HTML5_error_messages']) { ?> required style="box-shadow: 0 0 1px rgba(0,0,0, .4);" <?php }else{ ?> onchange="checkField(this)" <?php } ?> type="text" name="name" class="field" placeholder="Name *" value="<?php echo $_POST[name]; ?>" maxlength="<?php echo $number_of_characters_name; ?>" id="border-right"/>
			...
			<div class="row">
				<div class="col-sm-8 <?php if ($fehler["message"] != "") { echo 'error'; } ?>">
					...
					<textarea <?php if($cfg['HTML5_error_messages']) { ?> required <?php }else{ ?> onchange="checkField(this)" <?php } ?> aria-label="Nachricht" name="message" class="field" rows="5" placeholder="Message *" style="box-shadow: 0 0 1px rgba(0,0,0, .4);height:100%;width:100%;" id="border-right3"><?php echo $_POST[message]; ?></textarea>
